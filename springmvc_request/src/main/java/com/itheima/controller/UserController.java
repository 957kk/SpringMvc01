...
public class UserController {
    ...
    public String test1(Model model) {
        ...
        Address address = new Address("zhejiang", "hangzhou", "heima");
    ...
    @ResponseBody
    public Address j1() {
        Address address = new Address("浙江", "hangzhou", "heima");
        return address;
    }

    @RequestMapping(value = "j2")
    @ResponseBody
    public ArrayList<Address> j2() {
        Address address1 = new Address("浙江", "hangzhou", "heima");
        Address address2 = new Address("浙江", "hangzhou", "heima");
